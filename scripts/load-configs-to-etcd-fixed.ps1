...
# FreeRADIUS Configuration Loader for Windows - Fixed Version
# This script loads all FreeRADIUS configurations into ETCD v3
...
Write-Host "FreeRADIUS Configuration Loader for ETCD v3" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host
