...
# ============================================================================
# Config Sync Script for FreeRADIUS Load Balancer
...
# Main sync function
main_sync() {
    log "Starting configuration synchronization for load balancer..."
    ...
    sync_config "freeradius/loadbalancer/radiusd.conf" "/etc/raddb/radiusd.conf" && ((configs_synced++))
    sync_config "freeradius/loadbalancer/proxy.conf" "/etc/raddb/proxy.conf" && ((configs_synced++))
    sync_config "freeradius/loadbalancer/clients.conf" "/etc/raddb/clients.conf" && ((configs_synced++))
...
# Main loop
main() {
    log "Config Sync started for load balancer"
